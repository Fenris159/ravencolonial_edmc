...
| Version   | Summary                                                                                                        |
| --------- | -------------------------------------------------------------------------------------------------------------- |
| **1.6.3** | In development (see changelog **[1.6.3] - Unreleased**): plan-site link flow, **`architectName`**, **`/api/system/...`** normalization, duplicate-build guards, project GET cache / supply dedup, docs refresh. |
