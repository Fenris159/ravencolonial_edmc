...
| **Build tracker overlay**      | Optional in-game HUD for the selected **build** project via **EDMCModernOverlay**: grouped commodity need, ship cargo, optional carrier surplus/deficit, trips estimate, row bands, column dividers, and multiple color themes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
The optional overlay row appears on the main tab when EDMCModernOverlay is available. Enable it to show the selected **build** project in-game with **Need**, **Ship**, optional **FC's**, assignment hints, commodity categories, row bands, column dividers, and a footer with remaining units plus trip estimates from your current `CargoCapacity`.

Use **Select Build Project** to choose a `build` status site in the current system. Use **Enable Carrier Tracking** to show carrier surplus/deficit for **All** linked carriers or a single callsign. Overlay themes, including **Elite Orange** and **Cerulean Gold**, are configured under **File → Settings → Ravencolonial**.
